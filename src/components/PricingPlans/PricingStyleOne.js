        ...
        <div className="pricing-area pt-80 pb-50 bg-f9f6f6">
            <div className="container">
                <div className="section-title">
                    ...
                    <p>All prices below are One-Time development fees. Web hosting is included & managed by us for $12/Month (or $120/Year).</p>
                    <p></p>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-md-6">
                        <div className="pricing-table">
                            ...
                            <div className="content">
                                <div className="price">
                                    <span><sup>From $</sup>1,000 <span>One Time</span></span>
                                    <div className="subprice">
                                        <span>+$12<span>/Month (or $120/Year)</span></span>*
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="pricing-table active-plan">
                            ...
                            <div className="content">
                                <div className="price">
                                    <span><sup>From $</sup>2,200 <span>One Time</span></span>
                                    <div className="subprice">
                                        <span>+$20<span>/Month (or $200/Year)</span></span>*
                                    </div>
                                </div>
